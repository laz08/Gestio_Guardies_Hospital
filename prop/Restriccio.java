...
public abstract class Restriccio {
    ...
    /**
     * Donat una explresió com string retorna la part que es troba encapsulada
     * dins el parentesis que ve a continuació Es necessari que el primer que
     * trobi sigui un parentesi obert
     *
     * @param s Expresió d'on s'ha d'extreure el primer parentesis
     * @return Substring que conté l'explresio encapsulada dins el primer
     * parentesis de l'expresió
     */
    ...
    /**
     * Donat una part de la expresió, en treu la operació lògica que es troba a
     * continuació Es necessari que el primer que hi hagui a l'string sigui el
     * començament de l'operació lògica
     *
    ...
    /**
     * Retorna un valor boolea que determina si una expresió donada és una
     * restricció o no
     *
    ...
    /**
     * Retorna el nombre de vertex no fulles que formen el subarbre d'aquesta
     * restricció
     *
     * @return
     */
    ...
    /**
     * modifica el nombre de vertex no fulles que formen el subarbre d'aquesta
     * restricció
     *
    ...
    /**
     * Assigna un valor a la variable tipus que defineix si la restricció fa
     * referència a dies, hores o setmanes
     *
     * @param tipus
    ...
    /**
     * Retorna un String que determina si la restricció fa referència a dies,
     * hores o setmanes
     *
     * @return D, H o S
     */
